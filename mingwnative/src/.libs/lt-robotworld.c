...
/* ./.libs/lt-robotworld.c - temporary wrapper executable for .libs/robotworld.exe
   Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.11

   The robotworld program cannot be directly executed until all the libtool
...
const char * EXE_PATH_VALUE   = "C:\\boost\\lib;C:\\boost\\bin;C:\\Users\\nicov\\Documents\\HAN\\OSM-S\\wxWidgets-3.1.0\\mingw\\lib;C:\\Users\\nicov\\Documents\\HAN\\OSM-S\\wxWidgets-3.1.0\\mingw\\bin;";
const char * TARGET_PROGRAM_NAME = "robotworld.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# robotworld - temporary wrapper script for .libs/robotworld.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2 Debian-2.4.2-1.11\n", f);
  fputs ("#\n", f);
  fputs ("# The robotworld program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"robotworld.exe:robotworld:${LINENO}: libtool wrapper (GNU libtool) 2.", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"robotworld.exe:robotworld:${LINENO}: newargv[$lt_dump_args_N]: $lt_a", f);
  fputs ("rg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"robotworld.exe:robotworld:${LINENO}: newargv[0]: $progdir/$progr", f);
  fputs ("am\" 1>&2\n", f);
  ...
  fputs ("    PATH=/c/boost/lib:/c/boost/bin:/c/Users/nicov/Documents/HAN/OSM-S/wxWidgets", f);
  fputs ("-3.1.0/mingw/lib:/c/Users/nicov/Documents/HAN/OSM-S/wxWidgets-3.1.0/mingw/bin:$", f);
  fputs ("PATH\n", f);
  fputs ("\n", f);
  fputs ("    if test \"$libtool_execute_magic\" != \"%%%MAGIC variable%%%\"; then\n", f);
